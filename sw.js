const CACHE='lofi-room-v7';
const ASSETS=['./','index.html','manifest.webmanifest','icon.svg','sync.js','presets.json','assets/awake.jpg','assets/busy.jpg','assets/away.jpg','assets/ems.jpg'];
