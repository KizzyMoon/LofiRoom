const CACHE='lofi-room-v11';
const ASSETS=['./','index.html','manifest.webmanifest','icon.svg','presets.json','assets/awake.jpg','assets/busy.jpg','assets/away.jpg','assets/ems.jpg'];
